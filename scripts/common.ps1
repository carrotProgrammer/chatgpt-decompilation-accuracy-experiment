    ...
    switch ($Name.ToLowerInvariant()) {
        'adpcm' {
            return [pscustomobject]@{
                ...
                Source = Join-Path $paths.Root 'source\development\original\adpcm.c'
        ...
        'chal' {
            return [pscustomobject]@{
                ...
                Source = Join-Path $paths.Root 'source\development\original\chal.c'
        ...
        'portal' {
            return [pscustomobject]@{
                ...
                Source = Join-Path $paths.Root 'source\development\original\ticket_portal.c'
